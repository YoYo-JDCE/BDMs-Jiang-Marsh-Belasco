...
%we change the nu[2] to 0, when we are discussing the condition the BDM the
%same price as PEM;otherwise uu[2]=15, meaning the 50% increase of decay
%rate.
nu =[28785.02 15];
